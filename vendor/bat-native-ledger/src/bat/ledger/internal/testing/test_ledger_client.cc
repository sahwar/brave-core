...
TestLedgerClient::TestLedgerClient()
    : task_runner_(
      ...
      ledger_database_(UseTempDatabaseForTesting()),
...
void TestLedgerClient::RunDBTransaction(
  ...
  task_runner_->PostTaskAndReplyWithResult(
      FROM_HERE,
      base::BindOnce(&TestLedgerClient::RunDBTransactionInTask,
                     base::Unretained(this), std::move(transaction)),
...
type::DBCommandResponsePtr TestLedgerClient::RunDBTransactionInTask(
    type::DBTransactionPtr transaction) {
